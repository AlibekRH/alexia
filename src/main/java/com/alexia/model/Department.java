...
public class Department implements Serializable {
	...
	private Set<DepartmentTask> departmentTask = new HashSet<DepartmentTask>();
	...
	public Set<DepartmentTask> getDepartmentTask() {
		return departmentTask;
	}

	public void setDepartmentTask(Set<DepartmentTask> departmentTask) {
