...
public class Library implements Serializable {
	...
	private Set<LibraryTask> departmentTask = new HashSet<LibraryTask>();
	...
	public Set<LibraryTask> getDepartmentTask() {
		return departmentTask;
	}

	public void setDepartmentTask(Set<LibraryTask> departmentTask) {
